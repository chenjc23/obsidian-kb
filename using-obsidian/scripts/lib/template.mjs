...
export function targetPath(type, { repo, title, topic, flowFile } = {}) {
  switch (type) {
    ...
    case 'contract': return `contracts/${title}.md`;
    case 'coverage': return 'architecture/coverage.md';
    case 'use-case': return `use-cases/${title}.md`;
    case 'domain': return `domains/${title}.md`;
    case 'system-architecture': return 'architecture/system-architecture.md';
    ...
    case 'extra': return `extra/${title}.md`;
