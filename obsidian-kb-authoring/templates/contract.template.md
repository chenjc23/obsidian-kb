...
## Producer
<!-- 填:[[repos/{repo}/submodules/{topic}/overview]] 或 [[repos/{repo}/flows/{主题}/跨边界数据流]] — 发送场景;partial 时未知留「对端待 ingest」 -->

## Consumer
<!-- 填:[[repos/{repo}/submodules/{topic}/overview]] 或 [[repos/{repo}/flows/{主题}/跨边界数据流]] — 消费场景;partial 时未知留「对端待 ingest」 -->
